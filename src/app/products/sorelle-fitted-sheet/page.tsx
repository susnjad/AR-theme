...
const prices: Record<string, number> = { "Grand Single": 90, Queen: 120, King: 135 };

const variantIds: Record<string, Record<string, number>> = {
  Dusk:   { "Grand Single": 45090588688618, Queen: 45090588786922, King: 45090588885226 },
  Pearl:  { "Grand Single": 45090588721386, Queen: 45090588819690, King: 45090588917994 },
  Nebula: { "Grand Single": 45090588754154, Queen: 45090588852458, King: 45090588950762 },
};
...
const construction = [
  { layer: "01", title: "Bamboo Viscose", desc: "100% bamboo viscose — naturally temperature-regulating and moisture-wicking for a cool night's sleep." },
  { layer: "02", title: "Sateen Weave", desc: "4-over-1 sateen structure creates a silky, fluid surface that feels cool and smooth against the skin." },
  { layer: "03", title: "38cm Deep Pocket", desc: "Full surround elastic with a 38cm pocket depth. Holds firm on thick mattresses without shifting or bunching." },
  { layer: "04", title: "Tailored Corners", desc: "Precision-cut mitered corners sit flat and stay that way even after repeated washing." },
];
...
const relatedProducts = [
  ...
  { name: "Lierre — Fitted Sheet", href: "/products/lierre-fitted-sheet", image: "https://cdn.shopify.com/s/files/1/0691/8999/2682/files/dusksheet_0175f3cd-dad1-4425-8643-bd811e7c7e14.png?v=1763167314", price: "AUD $160" },
];

export default function SorelleFittedSheetPage() {
      ...
      <div className="section-container pt-28 pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
          <div className="flex gap-4">
            ...
            <div className="relative flex-1 overflow-hidden bg-[#e8e5de]" style={{ aspectRatio: "3/4" }}>
              <Image src={colour.images[activeImage]} alt={`Sorelle Fitted Sheet — ${colour.name}`} fill className="object-cover transition-opacity duration-500" sizes="(max-width: 1024px) 100vw, 50vw" priority />
            </div>
          </div>
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mb-8">
              ...
              <button
                  onClick={() => addItem({
                    id: `sorelle-sheet-${colour.name}-${activeSize}`,
                    productHandle: "sorelle-fitted-sheet",
                    name: "Sorelle — Fitted Sheet",
                    variant: `${colour.name} / ${activeSize}`,
                    price: prices[activeSize],
                    image: colour.images[0],
                    shopifyUrl: "https://aurumrest.com/products/bamboo-sheet",
            ...
            <div className="grid grid-cols-3 gap-4 py-6 border-y border-[#e0ddd6] mb-8">
              {[{ label: "Material", value: "Bamboo" }, { label: "Pocket", value: "38cm Deep" }, { label: "Certified", value: "OEKO-TEX" }].map((s) => (
        ...
        <div className="mt-24 pt-16 border-t border-[#e0ddd6]">
          <div className="mb-12">
            ...
            <h2 className="text-[32px] font-light tracking-[-0.02em] text-[#1a1a1a]">Cool to the touch. Stays in place.</h2>
          </div>
        ...
        <SorelleBundleSection currentKey="sheet" />
      </div>
      <Footer />
    </div>
  );
