...
import SorelleBundleSection from "@/components/SorelleBundleSection";
import { useCart } from "@/context/CartContext";

const colours = [
  { name: "Dusk", swatch: "#414141", images: ["https://cdn.shopify.com/s/files/1/0691/8999/2682/files/duskduvetcover_178cebf8-4145-4b47-a957-82ce9cbd2b8e.png?v=1763167314", "https://cdn.shopify.com/s/files/1/0691/8999/2682/files/packaging2_d8db8e72-0ef5-48e2-84e3-d96aae473897.jpg?v=1763167314"] },
  { name: "Pearl", swatch: "#e8e2d8", images: ["https://cdn.shopify.com/s/files/1/0691/8999/2682/files/pearlduvetcover_63e32d81-7a2b-4e4b-8984-af634da722a2.png?v=1763167314", "https://cdn.shopify.com/s/files/1/0691/8999/2682/files/packaging2_d8db8e72-0ef5-48e2-84e3-d96aae473897.jpg?v=1763167314"] },
  { name: "Nebula", swatch: "#272757", images: ["https://cdn.shopify.com/s/files/1/0691/8999/2682/files/nebuladuvetcover_efac4d22-48c1-4404-a06c-62659d1f5abd.png?v=1763167314", "https://cdn.shopify.com/s/files/1/0691/8999/2682/files/packaging2_d8db8e72-0ef5-48e2-84e3-d96aae473897.jpg?v=1763167314"] },
];

const sizes = ["Grand Single", "Queen", "King"];
const prices: Record<string, number> = { "Grand Single": 140, Queen: 180, King: 200 };

const variantIds: Record<string, Record<string, number>> = {
  Dusk:   { "Grand Single": 45090594521322, Queen: 45090594619626, King: 45090594717930 },
  Pearl:  { "Grand Single": 45090594554090, Queen: 45090594652394, King: 45090594750698 },
  Nebula: { "Grand Single": 45090594586858, Queen: 45090594685162, King: 45090594783466 },
};

const specs = [
  { label: "Material", value: "100% Bamboo Viscose" },
  { label: "Thread Count", value: "300TC" },
  { label: "Weave", value: "Sateen" },
  { label: "Closure", value: "Hidden button closure" },
  { label: "Care", value: "Machine wash cold, gentle cycle" },
  { label: "Certifications", value: "OEKO-TEX Standard 100" },
];

const construction = [
  { layer: "01", title: "Bamboo Viscose", desc: "100% bamboo viscose sourced from responsibly managed bamboo forests. Naturally antimicrobial and moisture-wicking." },
  { layer: "02", title: "300TC Sateen", desc: "Sateen weave creates a smooth, silky surface with a subtle sheen. Softer than cotton at the same thread count." },
  { layer: "03", title: "Cooling on Contact", desc: "Bamboo fibres pull heat away from the body on first contact, regulating temperature throughout the night." },
  { layer: "04", title: "Hidden Closure", desc: "Concealed button closure keeps the interior duvet neatly in place with no visible hardware." },
];

const relatedProducts = [
  { name: "Sorelle — Fitted Sheet", href: "/products/sorelle-fitted-sheet", image: "https://cdn.shopify.com/s/files/1/0691/8999/2682/files/dusk_sheet.png?v=1763167314", price: "AUD $90" },
  ...
  { name: "Lierre — Duvet Cover", href: "/products/lierre-duvet-cover", image: "https://cdn.shopify.com/s/files/1/0691/8999/2682/files/duskduvetcover_d5052fdf-c5b4-4f9f-b018-861ab55d2231.png?v=1763167315", price: "AUD $250" },
];

export default function SorelleDuvetCoverPage() {
      ...
      <div className="section-container pt-28 pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
          <div className="flex gap-4">
            ...
            <div className="relative flex-1 overflow-hidden bg-[#e8e5de]" style={{ aspectRatio: "3/4" }}>
              <Image src={colour.images[activeImage]} alt={`Sorelle Duvet Cover — ${colour.name}`} fill className="object-cover transition-opacity duration-500" sizes="(max-width: 1024px) 100vw, 50vw" priority />
            </div>
          </div>

          <div className="flex flex-col justify-center">
            <p className="text-[9px] uppercase tracking-[0.28em] text-[#9b9790] mb-3">Bamboo Viscose · Sorelle</p>
            ...
            <div className="mb-8">
              ...
              <button
                  onClick={() => addItem({
                    id: `sorelle-duvet-${colour.name}-${activeSize}`,
                    productHandle: "sorelle-duvet-cover",
                    name: "Sorelle — Duvet Cover",
                    variant: `${colour.name} / ${activeSize}`,
                    price: prices[activeSize],
                    image: colour.images[0],
                    shopifyUrl: "https://aurumrest.com/products/bamboo-duvet-cover",
            ...
            <div className="grid grid-cols-3 gap-4 py-6 border-y border-[#e0ddd6] mb-8">
              {[{ label: "Material", value: "Bamboo" }, { label: "Thread Count", value: "300TC" }, { label: "Certified", value: "OEKO-TEX" }].map((s) => (
        ...
        <div className="mt-24 pt-16 border-t border-[#e0ddd6]">
          <div className="mb-12">
            ...
            <h2 className="text-[32px] font-light tracking-[-0.02em] text-[#1a1a1a]">Cool on contact. Calm through the night.</h2>
          </div>
        ...
        <SorelleBundleSection currentKey="duvet" />
      </div>
      <Footer />
    </div>
  );
