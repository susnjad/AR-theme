...
const BUNDLE_ITEMS: BundleItem[] = [
  {
    ...
    prices: { "Grand Single": 140, Queen: 180, King: 200 },
  ...
  },
  {
    ...
    prices: { "Grand Single": 90, Queen: 120, King: 135 },
    sizes: ["Grand Single", "Queen", "King"],
    defaultSize: "Queen",
  },
    {
...
export default function SorelleBundleSection({ currentKey }: { currentKey: string }) {
    ...
    <div className="mt-24 pt-16 border-t border-[#e0ddd6]">
      <div className="flex items-end justify-between mb-3">
        <div>
          ...
          <h2 className="text-[26px] font-light tracking-[-0.02em] text-[#1a1a1a]">The Sorelle Bamboo Set</h2>
        </div>
