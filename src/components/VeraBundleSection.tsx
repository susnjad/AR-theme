...
const BUNDLE_ITEMS: BundleItem[] = [
  {
    ...
    prices: { "Grand Single": 120, Queen: 165, King: 185 },
  ...
  },
  {
    ...
    prices: { "Grand Single": 100, Queen: 130, King: 145 },
    sizes: ["Grand Single", "Queen", "King"],
    defaultSize: "Queen",
  },
    {
...
export default function VeraBundleSection({ currentKey }: { currentKey: string }) {
    ...
    <div className="mt-24 pt-16 border-t border-[#e0ddd6]">
      <div className="flex items-end justify-between mb-3">
        <div>
          ...
          <h2 className="text-[26px] font-light tracking-[-0.02em] text-[#1a1a1a]">The Vera TENCEL™ Set</h2>
        </div>
